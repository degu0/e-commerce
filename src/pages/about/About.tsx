...
export function About() {
        ...
        <div className="font-custom">
            ...
            <div className="xl:h-screen py-20 xl:p-0 w-full flex">
                <div className="w-full lg:w-1/2 2xl:w-4/5 grid justify-center content-center">
                    <h1 className="text-black text-6xl font-bold text-center lg:text-start mb-10">Our Story</h1>
                    <p className="text-black font-medium text-lg m-auto w-11/12 lg:m-0 2xl:text-xl 2xl:w-[625px]">
    ...
    hover:border-none hover:bg-red-custom hover:text-white hover:transition-colors hover:duration-500">
            ...
            <div className="xl:h-screen py-20 xl:p-0 flex flex-col gap-16 xl:flex-row items-center justify-around">
